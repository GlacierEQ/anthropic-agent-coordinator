...
```yaml
{
  ...
  "repository": {
    "id": "GlacierEQ/anthropic-agent-coordinator",
    "url": "https://github.com/GlacierEQ/anthropic-agent-coordinator",
  ...
  "provenance": {
    ...
    "contract_digest": "22a2ef687ded277f37ff8696f2a15067a3cb2eebf137ba3159b99f98379e5939"
  }
}
```
